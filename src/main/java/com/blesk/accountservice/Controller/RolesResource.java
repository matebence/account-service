...
public class RolesResource {
    ...
    public CollectionModel<List<Roles>> searchForRoles(@RequestBody HashMap<String, HashMap<String, String>> search, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
        ...
        if ((boolean) roles.get("hasPrev")) {
            collectionModel.add(linkTo(methodOn(this.getClass()).searchForRoles(search, httpServletRequest, httpServletResponse)).withRel("hasPrev"));
        }
        if ((boolean) roles.get("hasNext")) {
            collectionModel.add(linkTo(methodOn(this.getClass()).searchForRoles(search, httpServletRequest, httpServletResponse)).withRel("hasNext"));
        }
