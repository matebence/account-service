...
WHERE name IN ('CREATE_ACCOUNTS', 'DELETE_ACCOUNTS', 'UPDATE_ACCOUNTS', 'VIEW_ACCOUNTS', 'CREATE_PREFERENCES',
  'DELETE_PREFERENCES', 'UPDATE_PREFERENCES', 'VIEW_PREFERENCES', 'VIEW_GENDERS',	'CREATE_PAYMENTS',
  'CREATE_REFUNDS', 'DELETE_PAYMENTS', 'UPDATE_PAYMENTS', 'VIEW_PAYMENTS', 'CREATE_PAYOUTS', 'DELETE_PAYOUTS',
  'UPDATE_PAYOUTS', 'VIEW_PAYOUTS', 'CREATE_USERS', 'DELETE_USERS',	'UPDATE_USERS', 'VIEW_USERS',
